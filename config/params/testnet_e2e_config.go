...
const (
	...
	AlpacaE2EForkEpoch    = math.MaxUint64
	BadgerE2EForkEpoch    = math.MaxUint64
)
...
func E2ETestConfig() *BeaconChainConfig {
	...
	e2eConfig.AlpacaForkEpoch = AlpacaE2EForkEpoch
	e2eConfig.BadgerForkEpoch = BadgerE2EForkEpoch
	...
	e2eConfig.AlpacaForkVersion = []byte{5, 0, 0, 253}
	e2eConfig.BadgerForkVersion = []byte{6, 0, 0, 253}
...
func E2EMainnetTestConfig() *BeaconChainConfig {
	...
	e2eConfig.AlpacaForkVersion = []byte{5, 0, 0, 254}
	e2eConfig.BadgerForkVersion = []byte{6, 0, 0, 254}
