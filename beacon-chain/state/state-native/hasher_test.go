...
func TestComputeFieldRootsWithHasher_Phase0(t *testing.T) {
	...
	require.NoError(t, beaconState.SetPreviousEpochReserve(123))
	require.NoError(t, beaconState.SetCurrentEpochReserve(123))
...
func TestComputeFieldRootsWithHasher_Altair(t *testing.T) {
	...
	require.NoError(t, beaconState.SetBailOutScores([]uint64{1, 2, 3}))
