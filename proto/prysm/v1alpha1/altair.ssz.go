...
// Hash: 341038d3550a12730aac864456688f6726ae1b322df3951c1df08481028084b4
package eth
...
func (b *BailOut) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
func (b *BeaconStateAltair) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o10, o12, o13, o18, o19, o24, o25 uint64
