...
<<<<<<< HEAD
// Hash: 7f215086089828eb82088c710d9c0a40b2586632bd6a065cd6a5f2fc0fd10661
=======
// Hash: 2b4c92f49125b771c8aafdcae23c5ebf34b91f8cfd6b38e33a553c746ce4a578
>>>>>>> master
package eth
...
func (b *BeaconStateAltair) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o9, o11, o12, o15, o16, o21 uint64
...
// MarshalSSZ ssz marshals the BeaconStateOldAltair object
func (b *BeaconStateOldAltair) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconStateOldAltair object to a target array
func (b *BeaconStateOldAltair) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(2621841)
...
// UnmarshalSSZ ssz unmarshals the BeaconStateOldAltair object
func (b *BeaconStateOldAltair) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 2621841 {
		return ssz.ErrSize
	...
	tail := buf
	var o8, o10, o11, o13, o14, o19 uint64
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconStateOldAltair object
func (b *BeaconStateOldAltair) SizeSSZ() (size int) {
	size = 2621841
...
// HashTreeRoot ssz hashes the BeaconStateOldAltair object
func (b *BeaconStateOldAltair) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconStateOldAltair object with a hasher
func (b *BeaconStateOldAltair) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
