...
<<<<<<< HEAD
// Hash: 26ae1efce68f1c6a9151998dcb786e7af2e0691c134b073e2035208b9b369318
=======
// Hash: bf67b0486812561863c57eed70fff66654dcbadfd5ac6598b89b3db9f014961f
>>>>>>> master
package eth
...
func (b *BeaconStateBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o9, o11, o12, o15, o16, o21, o22 uint64
...
// MarshalSSZ ssz marshals the BeaconStateOldBellatrix object
func (b *BeaconStateOldBellatrix) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconStateOldBellatrix object to a target array
func (b *BeaconStateOldBellatrix) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(2621845)
...
// UnmarshalSSZ ssz unmarshals the BeaconStateOldBellatrix object
func (b *BeaconStateOldBellatrix) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 2621845 {
		return ssz.ErrSize
	...
	tail := buf
	var o8, o10, o11, o13, o14, o19, o20 uint64
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconStateOldBellatrix object
func (b *BeaconStateOldBellatrix) SizeSSZ() (size int) {
	size = 2621845
...
// HashTreeRoot ssz hashes the BeaconStateOldBellatrix object
func (b *BeaconStateOldBellatrix) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconStateOldBellatrix object with a hasher
func (b *BeaconStateOldBellatrix) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
