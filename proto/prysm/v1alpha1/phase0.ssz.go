...
// Hash: e32ae62e0c1a16a58ec25ef1d8b28a61caa8f68fe979f77f8f250b77c4520a96
package eth
...
// MarshalSSZ ssz marshals the BeaconStateOld object
func (b *BeaconStateOld) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconStateOld object to a target array
func (b *BeaconStateOld) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(2621837)
	...
	// Offset (13) 'PreviousEpochAttestations'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(b.PreviousEpochAttestations); ii++ {
		offset += 4
		offset += b.PreviousEpochAttestations[ii].SizeSSZ()
	...
	// Offset (14) 'CurrentEpochAttestations'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(b.CurrentEpochAttestations); ii++ {
		offset += 4
		offset += b.CurrentEpochAttestations[ii].SizeSSZ()
	...
	// Field (13) 'PreviousEpochAttestations'
	if size := len(b.PreviousEpochAttestations); size > 4096 {
		err = ssz.ErrListTooBigFn("--.PreviousEpochAttestations", size, 4096)
		return
	}
	...
	// Field (14) 'CurrentEpochAttestations'
	if size := len(b.CurrentEpochAttestations); size > 4096 {
		err = ssz.ErrListTooBigFn("--.CurrentEpochAttestations", size, 4096)
		return
	}
...
// UnmarshalSSZ ssz unmarshals the BeaconStateOld object
func (b *BeaconStateOld) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 2621837 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconStateOld object
func (b *BeaconStateOld) SizeSSZ() (size int) {
	size = 2621837
...
// HashTreeRoot ssz hashes the BeaconStateOld object
func (b *BeaconStateOld) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconStateOld object with a hasher
func (b *BeaconStateOld) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
func (v *Validator) UnmarshalSSZ(buf []byte) error {
	...
	// Field (7) 'PrincipalBalance'
	v.PrincipalBalance = ssz.UnmarshallUint64(buf[113:121])
