...
type BeaconBlockBodyAltair struct {
	...
	BailOuts          []*BailOut             `protobuf:"bytes,10,rep,name=bail_outs,json=bailOuts,proto3" json:"bail_outs,omitempty" ssz-max:"16"`
}
...
func (x *BeaconBlockBodyAltair) GetBailOuts() []*BailOut {
	if x != nil {
		return x.BailOuts
	}
	return nil
...
func (x *BailOut) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BailOut) ProtoMessage() {}

func (x *BailOut) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BailOut.ProtoReflect.Descriptor instead.
func (*BailOut) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_beacon_block_proto_rawDescGZIP(), []int{14}
}

func (x *BailOut) GetValidatorIndex() github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex {
	if x != nil {
		return x.ValidatorIndex
	}
	return github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(0)
...
type BeaconBlockBodyBellatrix struct {
	...
	SyncAggregate     *SyncAggregate         `protobuf:"bytes,9,opt,name=sync_aggregate,json=syncAggregate,proto3" json:"sync_aggregate,omitempty"`
	BailOuts          []*BailOut             `protobuf:"bytes,10,rep,name=bail_outs,json=bailOuts,proto3" json:"bail_outs,omitempty" ssz-max:"16"`
	ExecutionPayload  *v1.ExecutionPayload   `protobuf:"bytes,11,opt,name=execution_payload,json=executionPayload,proto3" json:"execution_payload,omitempty"`
}
...
func (x *BeaconBlockBodyBellatrix) GetBailOuts() []*BailOut {
	if x != nil {
		return x.BailOuts
	}
	return nil
...
type BlindedBeaconBlockBodyBellatrix struct {
	...
	SyncAggregate          *SyncAggregate             `protobuf:"bytes,9,opt,name=sync_aggregate,json=syncAggregate,proto3" json:"sync_aggregate,omitempty"`
	BailOuts               []*BailOut                 `protobuf:"bytes,10,rep,name=bail_outs,json=bailOuts,proto3" json:"bail_outs,omitempty" ssz-max:"16"`
	ExecutionPayloadHeader *v1.ExecutionPayloadHeader `protobuf:"bytes,11,opt,name=execution_payload_header,json=executionPayloadHeader,proto3" json:"execution_payload_header,omitempty"`
}
...
func (x *BlindedBeaconBlockBodyBellatrix) GetBailOuts() []*BailOut {
	if x != nil {
		return x.BailOuts
	}
	return nil
...
type BeaconBlockBodyDeneb struct {
	...
	SyncAggregate         *SyncAggregate                `protobuf:"bytes,9,opt,name=sync_aggregate,json=syncAggregate,proto3" json:"sync_aggregate,omitempty"`
	BailOuts              []*BailOut                    `protobuf:"bytes,10,rep,name=bail_outs,json=bailOuts,proto3" json:"bail_outs,omitempty" ssz-max:"16"`
	ExecutionPayload      *v1.ExecutionPayloadDeneb     `protobuf:"bytes,11,opt,name=execution_payload,json=executionPayload,proto3" json:"execution_payload,omitempty"`
	BlsToExecutionChanges []*SignedBLSToExecutionChange `protobuf:"bytes,12,rep,name=bls_to_execution_changes,json=blsToExecutionChanges,proto3" json:"bls_to_execution_changes,omitempty" ssz-max:"16"`
	BlobKzgCommitments    [][]byte                      `protobuf:"bytes,13,rep,name=blob_kzg_commitments,json=blobKzgCommitments,proto3" json:"blob_kzg_commitments,omitempty" ssz-max:"4096" ssz-size:"?,48"`
}
...
func (x *BeaconBlockBodyDeneb) GetBailOuts() []*BailOut {
	if x != nil {
		return x.BailOuts
	}
	return nil
...
type BeaconBlockBodyCapella struct {
	...
	SyncAggregate         *SyncAggregate                `protobuf:"bytes,9,opt,name=sync_aggregate,json=syncAggregate,proto3" json:"sync_aggregate,omitempty"`
	BailOuts              []*BailOut                    `protobuf:"bytes,10,rep,name=bail_outs,json=bailOuts,proto3" json:"bail_outs,omitempty" ssz-max:"16"`
	ExecutionPayload      *v1.ExecutionPayloadCapella   `protobuf:"bytes,11,opt,name=execution_payload,json=executionPayload,proto3" json:"execution_payload,omitempty"`
	BlsToExecutionChanges []*SignedBLSToExecutionChange `protobuf:"bytes,12,rep,name=bls_to_execution_changes,json=blsToExecutionChanges,proto3" json:"bls_to_execution_changes,omitempty" ssz-max:"16"`
}
...
func (x *BeaconBlockBodyCapella) GetBailOuts() []*BailOut {
	if x != nil {
		return x.BailOuts
	}
	return nil
...
type BlindedBeaconBlockBodyCapella struct {
	...
	SyncAggregate          *SyncAggregate                    `protobuf:"bytes,9,opt,name=sync_aggregate,json=syncAggregate,proto3" json:"sync_aggregate,omitempty"`
	BailOuts               []*BailOut                        `protobuf:"bytes,10,rep,name=bail_outs,json=bailOuts,proto3" json:"bail_outs,omitempty" ssz-max:"16"`
	ExecutionPayloadHeader *v1.ExecutionPayloadHeaderCapella `protobuf:"bytes,11,opt,name=execution_payload_header,json=executionPayloadHeader,proto3" json:"execution_payload_header,omitempty"`
	BlsToExecutionChanges  []*SignedBLSToExecutionChange     `protobuf:"bytes,12,rep,name=bls_to_execution_changes,json=blsToExecutionChanges,proto3" json:"bls_to_execution_changes,omitempty" ssz-max:"16"`
}
...
func (x *BlindedBeaconBlockBodyCapella) GetBailOuts() []*BailOut {
	if x != nil {
		return x.BailOuts
	}
	return nil
...
type BlindedBeaconBlockBodyDeneb struct {
	...
	SyncAggregate          *SyncAggregate                  `protobuf:"bytes,9,opt,name=sync_aggregate,json=syncAggregate,proto3" json:"sync_aggregate,omitempty"`
	BailOuts               []*BailOut                      `protobuf:"bytes,10,rep,name=bail_outs,json=bailOuts,proto3" json:"bail_outs,omitempty" ssz-max:"16"`
	ExecutionPayloadHeader *v1.ExecutionPayloadHeaderDeneb `protobuf:"bytes,11,opt,name=execution_payload_header,json=executionPayloadHeader,proto3" json:"execution_payload_header,omitempty"`
	BlsToExecutionChanges  []*SignedBLSToExecutionChange   `protobuf:"bytes,12,rep,name=bls_to_execution_changes,json=blsToExecutionChanges,proto3" json:"bls_to_execution_changes,omitempty" ssz-max:"16"`
	BlobKzgCommitments     [][]byte                        `protobuf:"bytes,13,rep,name=blob_kzg_commitments,json=blobKzgCommitments,proto3" json:"blob_kzg_commitments,omitempty" ssz-max:"4096" ssz-size:"?,48"`
}
...
func (x *BlindedBeaconBlockBodyDeneb) GetBailOuts() []*BailOut {
	if x != nil {
		return x.BailOuts
	}
	return nil
...
type BeaconBlockBodyElectra struct {
	...
	BlsToExecutionChanges []*SignedBLSToExecutionChange `protobuf:"bytes,12,rep,name=bls_to_execution_changes,json=blsToExecutionChanges,proto3" json:"bls_to_execution_changes,omitempty" ssz-max:"16"`
	BlobKzgCommitments    [][]byte                      `protobuf:"bytes,13,rep,name=blob_kzg_commitments,json=blobKzgCommitments,proto3" json:"blob_kzg_commitments,omitempty" ssz-max:"4096" ssz-size:"?,48"`
	ExecutionRequests     *v1.ExecutionRequests         `protobuf:"bytes,14,opt,name=execution_requests,json=executionRequests,proto3" json:"execution_requests,omitempty"`
}
...
func (x *BeaconBlockBodyElectra) GetBailOuts() []*BailOut {
	if x != nil {
		return x.BailOuts
	}
	return nil
...
func (x *BlindedBeaconBlockBodyElectra) GetBailOuts() []*BailOut {
	if x != nil {
		return x.BailOuts
	}
	return nil
...
var file_proto_prysm_v1alpha1_beacon_block_proto_rawDesc = []byte{
	...
	0x72, 0x79, 0x45, 0x78, 0x69, 0x74, 0x73, 0x22, 0xe9, 0x05, 0x0a, 0x15, 0x42, 0x65, 0x61, 0x63,
	...
	0x0d, 0x73, 0x79, 0x6e, 0x63, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x12, 0x43,
	0x0a, 0x09, 0x62, 0x61, 0x69, 0x6c, 0x5f, 0x6f, 0x75, 0x74, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x1e, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68,
	0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x42, 0x61, 0x69, 0x6c, 0x4f, 0x75,
	0x74, 0x42, 0x06, 0x92, 0xb5, 0x18, 0x02, 0x31, 0x36, 0x52, 0x08, 0x62, 0x61, 0x69, 0x6c, 0x4f,
	0x75, 0x74, 0x73, 0x22, 0xa8, 0x01, 0x0a, 0x10, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72,
	...
	0x61, 0x31, 0x2e, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x65, 0x64, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0c, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x32, 0x22, 0xc7, 0x01, 0x0a, 0x17, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x65, 0x72,
	0x53, 0x6c, 0x61, 0x73, 0x68, 0x69, 0x6e, 0x67, 0x45, 0x6c, 0x65, 0x63, 0x74, 0x72, 0x61, 0x12,
	0x55, 0x0a, 0x0d, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x31,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x31, 0x12, 0x55, 0x0a, 0x0d, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x32, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30, 0x2e,
	0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61,
	...
	0x0c, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x22, 0x9a, 0x02,
	...
	0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xe7, 0x01, 0x0a, 0x0d, 0x56,
	0x6f, 0x6c, 0x75, 0x6e, 0x74, 0x61, 0x72, 0x79, 0x45, 0x78, 0x69, 0x74, 0x12, 0x5c, 0x0a, 0x05,
	...
	0x6f, 0x63, 0x68, 0x52, 0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x12, 0x78, 0x0a, 0x0f, 0x76, 0x61,
	...
	0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x83, 0x01, 0x0a, 0x07,
	0x42, 0x61, 0x69, 0x6c, 0x4f, 0x75, 0x74, 0x12, 0x78, 0x0a, 0x0f, 0x76, 0x61, 0x6c, 0x69, 0x64,
	...
	0x78, 0x22, 0x81, 0x01, 0x0a, 0x08, 0x45, 0x74, 0x68, 0x31, 0x44, 0x61, 0x74, 0x61, 0x12, 0x29,
	...
	0x6b, 0x48, 0x61, 0x73, 0x68, 0x22, 0xdb, 0x02, 0x0a, 0x11, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e,
	0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x59, 0x0a, 0x04, 0x73,
	...
	0x20, 0x01, 0x28, 0x0c, 0x42, 0x06, 0x8a, 0xb5, 0x18, 0x02, 0x39, 0x36, 0x52, 0x09, 0x73, 0x69,
	0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xb6, 0x01, 0x0a, 0x19, 0x49, 0x6e, 0x64, 0x65,
	0x78, 0x65, 0x64, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x6c,
	0x65, 0x63, 0x74, 0x72, 0x61, 0x12, 0x37, 0x0a, 0x11, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74, 0x69,
	0x6e, 0x67, 0x5f, 0x69, 0x6e, 0x64, 0x69, 0x63, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x04,
	0x42, 0x0a, 0x92, 0xb5, 0x18, 0x06, 0x31, 0x33, 0x31, 0x30, 0x37, 0x32, 0x52, 0x10, 0x61, 0x74,
	...
	0x74, 0x72, 0x69, 0x78, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0xbf, 0x06, 0x0a, 0x18, 0x42,
	...
	0x67, 0x61, 0x74, 0x65, 0x12, 0x43, 0x0a, 0x09, 0x62, 0x61, 0x69, 0x6c, 0x5f, 0x6f, 0x75, 0x74,
	0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65,
	0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e,
	0x42, 0x61, 0x69, 0x6c, 0x4f, 0x75, 0x74, 0x42, 0x06, 0x92, 0xb5, 0x18, 0x02, 0x31, 0x36, 0x52,
	0x08, 0x62, 0x61, 0x69, 0x6c, 0x4f, 0x75, 0x74, 0x73, 0x12, 0x51, 0x0a, 0x11, 0x65, 0x78, 0x65,
	0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x18, 0x0b,
	...
	0x79, 0x22, 0xd9, 0x06, 0x0a, 0x1f, 0x42, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x42, 0x65, 0x61,
	...
	0x74, 0x65, 0x12, 0x43, 0x0a, 0x09, 0x62, 0x61, 0x69, 0x6c, 0x5f, 0x6f, 0x75, 0x74, 0x73, 0x18,
	0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d,
	0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x42, 0x61,
	0x69, 0x6c, 0x4f, 0x75, 0x74, 0x42, 0x06, 0x92, 0xb5, 0x18, 0x02, 0x31, 0x36, 0x52, 0x08, 0x62,
	0x61, 0x69, 0x6c, 0x4f, 0x75, 0x74, 0x73, 0x12, 0x64, 0x0a, 0x18, 0x65, 0x78, 0x65, 0x63, 0x75,
	0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x68, 0x65, 0x61,
	0x64, 0x65, 0x72, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x65, 0x74, 0x68, 0x65,
	...
	0x6f, 0x64, 0x79, 0x22, 0xf8, 0x07, 0x0a, 0x14, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c,
	...
	,
	...
	0x65, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72,
	0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31,
	...
	0x74, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0c, 0x42, 0x10, 0x8a, 0xb5, 0x18, 0x04, 0x3f, 0x2c,
	...
	0xb8, 0x07, 0x0a, 0x16, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x42,
	...
	0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x12, 0x43, 0x0a, 0x09, 0x62, 0x61, 0x69, 0x6c, 0x5f,
	0x6f, 0x75, 0x74, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x65, 0x74, 0x68,
	0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68,
	0x61, 0x31, 0x2e, 0x42, 0x61, 0x69, 0x6c, 0x4f, 0x75, 0x74, 0x42, 0x06, 0x92, 0xb5, 0x18, 0x02,
	0x31, 0x36, 0x52, 0x08, 0x62, 0x61, 0x69, 0x6c, 0x4f, 0x75, 0x74, 0x73, 0x12, 0x58, 0x0a, 0x11,
	0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61,
	0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65,
	...
	0x61, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0xd2, 0x07, 0x0a, 0x1d, 0x42, 0x6c, 0x69, 0x6e,
	0x64, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x42, 0x6f,
	...
	0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x12, 0x43, 0x0a, 0x09, 0x62, 0x61, 0x69, 0x6c, 0x5f, 0x6f,
	0x75, 0x74, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x65, 0x74, 0x68, 0x65,
	0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61,
	0x31, 0x2e, 0x42, 0x61, 0x69, 0x6c, 0x4f, 0x75, 0x74, 0x42, 0x06, 0x92, 0xb5, 0x18, 0x02, 0x31,
	0x36, 0x52, 0x08, 0x62, 0x61, 0x69, 0x6c, 0x4f, 0x75, 0x74, 0x73, 0x12, 0x6b, 0x0a, 0x18, 0x65,
	0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64,
	0x5f, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31, 0x2e,
	...
	0x6e, 0x67, 0x65, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x65, 0x74, 0x68,
	0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68,
	...
	0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0x92, 0x08, 0x0a, 0x1b, 0x42, 0x6c, 0x69, 0x6e, 0x64, 0x65,
	...
	0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x42, 0x61,
	0x69, 0x6c, 0x4f, 0x75, 0x74, 0x42, 0x06, 0x92, 0xb5, 0x18, 0x02, 0x31, 0x36, 0x52, 0x08, 0x62,
	0x61, 0x69, 0x6c, 0x4f, 0x75, 0x74, 0x73, 0x12, 0x69, 0x0a, 0x18, 0x65, 0x78, 0x65, 0x63, 0x75,
	0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x68, 0x65, 0x61,
	0x64, 0x65, 0x72, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x65, 0x74, 0x68, 0x65,
	0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x45,
	0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x48,
	...
	0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x18, 0x0c,
	...
	0x7a, 0x67, 0x5f, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x0d,
	...
	0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xc6, 0x01, 0x0a, 0x20, 0x53,
	0x69, 0x67, 0x6e, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b,
	...
	0x6f, 0x62, 0x73, 0x22, 0xba, 0x01, 0x0a, 0x1a, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c,
	...
	0x22, 0x81, 0x01, 0x0a, 0x18, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f,
	0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x45, 0x6c, 0x65, 0x63, 0x74, 0x72, 0x61, 0x12, 0x3f, 0x0a,
	...
	0x74, 0x75, 0x72, 0x65, 0x22, 0xfa, 0x02, 0x0a, 0x12, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42,
	...
	0x79, 0x22, 0xdc, 0x08, 0x0a, 0x16, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63,
	...
	0x65, 0x67, 0x61, 0x74, 0x65, 0x12, 0x43, 0x0a, 0x09, 0x62, 0x61, 0x69, 0x6c, 0x5f, 0x6f, 0x75,
	0x74, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72,
	0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31,
	0x2e, 0x42, 0x61, 0x69, 0x6c, 0x4f, 0x75, 0x74, 0x42, 0x06, 0x92, 0xb5, 0x18, 0x02, 0x31, 0x36,
	0x52, 0x08, 0x62, 0x61, 0x69, 0x6c, 0x4f, 0x75, 0x74, 0x73, 0x12, 0x56, 0x0a, 0x11, 0x65, 0x78,
	0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x18,
	0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d,
	...
	0x18, 0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75,
	...
	0x69, 0x6e, 0x64, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b,
	0x42, 0x6f, 0x64, 0x79, 0x45, 0x6c, 0x65, 0x63, 0x74, 0x72, 0x61, 0x52, 0x04, 0x62, 0x6f, 0x64,
	0x79, 0x22, 0xf6, 0x08, 0x0a, 0x1d, 0x42, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x42, 0x65, 0x61,
	...
	0x79, 0x6e, 0x63, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x12, 0x43, 0x0a, 0x09,
	0x62, 0x61, 0x69, 0x6c, 0x5f, 0x6f, 0x75, 0x74, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x1e, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76,
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x42, 0x61, 0x69, 0x6c, 0x4f, 0x75, 0x74, 0x42,
	0x06, 0x92, 0xb5, 0x18, 0x02, 0x31, 0x36, 0x52, 0x08, 0x62, 0x61, 0x69, 0x6c, 0x4f, 0x75, 0x74,
	0x73, 0x12, 0x69, 0x0a, 0x18, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70,
	...
	0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31,
	0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31,
	...
	0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0c, 0x42, 0x10,
	...
	0x6e, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0b,
	...
	0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x22, 0xa1, 0x01, 0x0a, 0x17, 0x56,
...
var file_proto_prysm_v1alpha1_beacon_block_proto_goTypes = []interface{}{
	...
	(*BailOut)(nil),                           // 14: ethereum.eth.v1alpha1.BailOut
	...
	(*IndexedAttestationElectra)(nil),         // 19: ethereum.eth.v1alpha1.IndexedAttestationElectra
	(*SyncAggregate)(nil),                     // 20: ethereum.eth.v1alpha1.SyncAggregate
	(*SignedBeaconBlockBellatrix)(nil),        // 21: ethereum.eth.v1alpha1.SignedBeaconBlockBellatrix
	(*BeaconBlockBellatrix)(nil),              // 22: ethereum.eth.v1alpha1.BeaconBlockBellatrix
	(*BeaconBlockBodyBellatrix)(nil),          // 23: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix
	(*SignedBlindedBeaconBlockBellatrix)(nil), // 24: ethereum.eth.v1alpha1.SignedBlindedBeaconBlockBellatrix
	(*BlindedBeaconBlockBellatrix)(nil),       // 25: ethereum.eth.v1alpha1.BlindedBeaconBlockBellatrix
	(*BlindedBeaconBlockBodyBellatrix)(nil),   // 26: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix
	(*SignedBeaconBlockContentsDeneb)(nil),    // 27: ethereum.eth.v1alpha1.SignedBeaconBlockContentsDeneb
	(*BeaconBlockContentsDeneb)(nil),          // 28: ethereum.eth.v1alpha1.BeaconBlockContentsDeneb
	(*SignedBeaconBlockDeneb)(nil),            // 29: ethereum.eth.v1alpha1.SignedBeaconBlockDeneb
	(*BeaconBlockDeneb)(nil),                  // 30: ethereum.eth.v1alpha1.BeaconBlockDeneb
	(*BeaconBlockBodyDeneb)(nil),              // 31: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb
	(*SignedBeaconBlockCapella)(nil),          // 32: ethereum.eth.v1alpha1.SignedBeaconBlockCapella
	(*BeaconBlockCapella)(nil),                // 33: ethereum.eth.v1alpha1.BeaconBlockCapella
	(*BeaconBlockBodyCapella)(nil),            // 34: ethereum.eth.v1alpha1.BeaconBlockBodyCapella
	(*SignedBlindedBeaconBlockCapella)(nil),   // 35: ethereum.eth.v1alpha1.SignedBlindedBeaconBlockCapella
	(*BlindedBeaconBlockCapella)(nil),         // 36: ethereum.eth.v1alpha1.BlindedBeaconBlockCapella
	(*BlindedBeaconBlockBodyCapella)(nil),     // 37: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella
	...
	(*SignedBeaconBlockContentsElectra)(nil),  // 41: ethereum.eth.v1alpha1.SignedBeaconBlockContentsElectra
	(*BeaconBlockContentsElectra)(nil),        // 42: ethereum.eth.v1alpha1.BeaconBlockContentsElectra
	(*SignedBeaconBlockElectra)(nil),          // 43: ethereum.eth.v1alpha1.SignedBeaconBlockElectra
	(*BeaconBlockElectra)(nil),                // 44: ethereum.eth.v1alpha1.BeaconBlockElectra
	(*BeaconBlockBodyElectra)(nil),            // 45: ethereum.eth.v1alpha1.BeaconBlockBodyElectra
	(*SignedBlindedBeaconBlockElectra)(nil),   // 46: ethereum.eth.v1alpha1.SignedBlindedBeaconBlockElectra
	(*BlindedBeaconBlockElectra)(nil),         // 47: ethereum.eth.v1alpha1.BlindedBeaconBlockElectra
	(*BlindedBeaconBlockBodyElectra)(nil),     // 48: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra
	(*ValidatorRegistrationV1)(nil),           // 49: ethereum.eth.v1alpha1.ValidatorRegistrationV1
	(*SignedValidatorRegistrationsV1)(nil),    // 50: ethereum.eth.v1alpha1.SignedValidatorRegistrationsV1
	(*SignedValidatorRegistrationV1)(nil),     // 51: ethereum.eth.v1alpha1.SignedValidatorRegistrationV1
	(*BuilderBid)(nil),                        // 52: ethereum.eth.v1alpha1.BuilderBid
	(*SignedBuilderBid)(nil),                  // 53: ethereum.eth.v1alpha1.SignedBuilderBid
	(*BuilderBidCapella)(nil),                 // 54: ethereum.eth.v1alpha1.BuilderBidCapella
	(*SignedBuilderBidCapella)(nil),           // 55: ethereum.eth.v1alpha1.SignedBuilderBidCapella
	(*BuilderBidDeneb)(nil),                   // 56: ethereum.eth.v1alpha1.BuilderBidDeneb
	(*SignedBuilderBidDeneb)(nil),             // 57: ethereum.eth.v1alpha1.SignedBuilderBidDeneb
	(*BlobSidecar)(nil),                       // 58: ethereum.eth.v1alpha1.BlobSidecar
	(*BlobSidecars)(nil),                      // 59: ethereum.eth.v1alpha1.BlobSidecars
	(*Deposit_Data)(nil),                      // 60: ethereum.eth.v1alpha1.Deposit.Data
	...
	(*v1.ExecutionPayloadDeneb)(nil),          // 65: ethereum.engine.v1.ExecutionPayloadDeneb
	(*SignedBLSToExecutionChange)(nil),        // 66: ethereum.eth.v1alpha1.SignedBLSToExecutionChange
	(*v1.ExecutionPayloadCapella)(nil),        // 67: ethereum.engine.v1.ExecutionPayloadCapella
	(*v1.ExecutionPayloadHeaderCapella)(nil),  // 68: ethereum.engine.v1.ExecutionPayloadHeaderCapella
	(*v1.ExecutionPayloadHeaderDeneb)(nil),    // 69: ethereum.engine.v1.ExecutionPayloadHeaderDeneb
	(*AttestationElectra)(nil),                // 70: ethereum.eth.v1alpha1.AttestationElectra
	(*v1.ExecutionRequests)(nil),              // 71: ethereum.engine.v1.ExecutionRequests
}
var file_proto_prysm_v1alpha1_beacon_block_proto_depIdxs = []int32{
	...
	21,  // 2: ethereum.eth.v1alpha1.GenericSignedBeaconBlock.bellatrix:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockBellatrix
	24,  // 3: ethereum.eth.v1alpha1.GenericSignedBeaconBlock.blinded_bellatrix:type_name -> ethereum.eth.v1alpha1.SignedBlindedBeaconBlockBellatrix
	32,  // 4: ethereum.eth.v1alpha1.GenericSignedBeaconBlock.capella:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockCapella
	35,  // 5: ethereum.eth.v1alpha1.GenericSignedBeaconBlock.blinded_capella:type_name -> ethereum.eth.v1alpha1.SignedBlindedBeaconBlockCapella
	27,  // 6: ethereum.eth.v1alpha1.GenericSignedBeaconBlock.deneb:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockContentsDeneb
	...
	41,  // 8: ethereum.eth.v1alpha1.GenericSignedBeaconBlock.electra:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockContentsElectra
	46,  // 9: ethereum.eth.v1alpha1.GenericSignedBeaconBlock.blinded_electra:type_name -> ethereum.eth.v1alpha1.SignedBlindedBeaconBlockElectra
	...
	22,  // 12: ethereum.eth.v1alpha1.GenericBeaconBlock.bellatrix:type_name -> ethereum.eth.v1alpha1.BeaconBlockBellatrix
	25,  // 13: ethereum.eth.v1alpha1.GenericBeaconBlock.blinded_bellatrix:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockBellatrix
	33,  // 14: ethereum.eth.v1alpha1.GenericBeaconBlock.capella:type_name -> ethereum.eth.v1alpha1.BeaconBlockCapella
	36,  // 15: ethereum.eth.v1alpha1.GenericBeaconBlock.blinded_capella:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockCapella
	28,  // 16: ethereum.eth.v1alpha1.GenericBeaconBlock.deneb:type_name -> ethereum.eth.v1alpha1.BeaconBlockContentsDeneb
	39,  // 17: ethereum.eth.v1alpha1.GenericBeaconBlock.blinded_deneb:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockDeneb
	42,  // 18: ethereum.eth.v1alpha1.GenericBeaconBlock.electra:type_name -> ethereum.eth.v1alpha1.BeaconBlockContentsElectra
	47,  // 19: ethereum.eth.v1alpha1.GenericBeaconBlock.blinded_electra:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockElectra
	...
	15,  // 24: ethereum.eth.v1alpha1.BeaconBlockBody.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	...
	61,  // 27: ethereum.eth.v1alpha1.BeaconBlockBody.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	...
	15,  // 30: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	...
	61,  // 33: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	...
	20,  // 36: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	14,  // 37: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.bail_outs:type_name -> ethereum.eth.v1alpha1.BailOut
	17,  // 38: ethereum.eth.v1alpha1.ProposerSlashing.header_1:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockHeader
	17,  // 39: ethereum.eth.v1alpha1.ProposerSlashing.header_2:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockHeader
	18,  // 40: ethereum.eth.v1alpha1.AttesterSlashing.attestation_1:type_name -> ethereum.eth.v1alpha1.IndexedAttestation
	18,  // 41: ethereum.eth.v1alpha1.AttesterSlashing.attestation_2:type_name -> ethereum.eth.v1alpha1.IndexedAttestation
	19,  // 42: ethereum.eth.v1alpha1.AttesterSlashingElectra.attestation_1:type_name -> ethereum.eth.v1alpha1.IndexedAttestationElectra
	19,  // 43: ethereum.eth.v1alpha1.AttesterSlashingElectra.attestation_2:type_name -> ethereum.eth.v1alpha1.IndexedAttestationElectra
	60,  // 44: ethereum.eth.v1alpha1.Deposit.data:type_name -> ethereum.eth.v1alpha1.Deposit.Data
	12,  // 45: ethereum.eth.v1alpha1.SignedVoluntaryExit.exit:type_name -> ethereum.eth.v1alpha1.VoluntaryExit
	16,  // 46: ethereum.eth.v1alpha1.SignedBeaconBlockHeader.header:type_name -> ethereum.eth.v1alpha1.BeaconBlockHeader
	62,  // 47: ethereum.eth.v1alpha1.IndexedAttestation.data:type_name -> ethereum.eth.v1alpha1.AttestationData
	62,  // 48: ethereum.eth.v1alpha1.IndexedAttestationElectra.data:type_name -> ethereum.eth.v1alpha1.AttestationData
	22,  // 49: ethereum.eth.v1alpha1.SignedBeaconBlockBellatrix.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockBellatrix
	23,  // 50: ethereum.eth.v1alpha1.BeaconBlockBellatrix.body:type_name -> ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix
	15,  // 51: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	...
	61,  // 54: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	11,  // 55: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	13,  // 56: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	20,  // 57: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	14,  // 58: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.bail_outs:type_name -> ethereum.eth.v1alpha1.BailOut
	63,  // 59: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayload
	25,  // 60: ethereum.eth.v1alpha1.SignedBlindedBeaconBlockBellatrix.block:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockBellatrix
	26,  // 61: ethereum.eth.v1alpha1.BlindedBeaconBlockBellatrix.body:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix
	15,  // 62: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	...
	61,  // 65: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	...
	20,  // 68: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	14,  // 69: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.bail_outs:type_name -> ethereum.eth.v1alpha1.BailOut
	64,  // 70: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeader
	29,  // 71: ethereum.eth.v1alpha1.SignedBeaconBlockContentsDeneb.block:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockDeneb
	30,  // 72: ethereum.eth.v1alpha1.BeaconBlockContentsDeneb.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockDeneb
	30,  // 73: ethereum.eth.v1alpha1.SignedBeaconBlockDeneb.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockDeneb
	31,  // 74: ethereum.eth.v1alpha1.BeaconBlockDeneb.body:type_name -> ethereum.eth.v1alpha1.BeaconBlockBodyDeneb
	15,  // 75: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	8,   // 76: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	9,   // 77: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashing
	61,  // 78: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	11,  // 79: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	13,  // 80: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	20,  // 81: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	14,  // 82: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.bail_outs:type_name -> ethereum.eth.v1alpha1.BailOut
	65,  // 83: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayloadDeneb
	66,  // 84: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.bls_to_execution_changes:type_name -> ethereum.eth.v1alpha1.SignedBLSToExecutionChange
	33,  // 85: ethereum.eth.v1alpha1.SignedBeaconBlockCapella.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockCapella
	34,  // 86: ethereum.eth.v1alpha1.BeaconBlockCapella.body:type_name -> ethereum.eth.v1alpha1.BeaconBlockBodyCapella
	15,  // 87: ethereum.eth.v1alpha1.BeaconBlockBodyCapella.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	8,   // 88: ethereum.eth.v1alpha1.BeaconBlockBodyCapella.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	9,   // 89: ethereum.eth.v1alpha1.BeaconBlockBodyCapella.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashing
	61,  // 90: ethereum.eth.v1alpha1.BeaconBlockBodyCapella.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	11,  // 91: ethereum.eth.v1alpha1.BeaconBlockBodyCapella.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	13,  // 92: ethereum.eth.v1alpha1.BeaconBlockBodyCapella.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	20,  // 93: ethereum.eth.v1alpha1.BeaconBlockBodyCapella.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	14,  // 94: ethereum.eth.v1alpha1.BeaconBlockBodyCapella.bail_outs:type_name -> ethereum.eth.v1alpha1.BailOut
	67,  // 95: ethereum.eth.v1alpha1.BeaconBlockBodyCapella.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayloadCapella
	66,  // 96: ethereum.eth.v1alpha1.BeaconBlockBodyCapella.bls_to_execution_changes:type_name -> ethereum.eth.v1alpha1.SignedBLSToExecutionChange
	36,  // 97: ethereum.eth.v1alpha1.SignedBlindedBeaconBlockCapella.block:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockCapella
	37,  // 98: ethereum.eth.v1alpha1.BlindedBeaconBlockCapella.body:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella
	15,  // 99: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	8,   // 100: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	9,   // 101: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashing
	61,  // 102: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	11,  // 103: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	13,  // 104: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	20,  // 105: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	14,  // 106: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.bail_outs:type_name -> ethereum.eth.v1alpha1.BailOut
	68,  // 107: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderCapella
	66,  // 108: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.bls_to_execution_changes:type_name -> ethereum.eth.v1alpha1.SignedBLSToExecutionChange
	39,  // 109: ethereum.eth.v1alpha1.SignedBlindedBeaconBlockDeneb.message:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockDeneb
	40,  // 110: ethereum.eth.v1alpha1.BlindedBeaconBlockDeneb.body:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb
	15,  // 111: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	8,   // 112: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	9,   // 113: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashing
	61,  // 114: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	11,  // 115: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	13,  // 116: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	20,  // 117: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	14,  // 118: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.bail_outs:type_name -> ethereum.eth.v1alpha1.BailOut
	69,  // 119: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderDeneb
	66,  // 120: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.bls_to_execution_changes:type_name -> ethereum.eth.v1alpha1.SignedBLSToExecutionChange
	43,  // 121: ethereum.eth.v1alpha1.SignedBeaconBlockContentsElectra.block:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockElectra
	44,  // 122: ethereum.eth.v1alpha1.BeaconBlockContentsElectra.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockElectra
	44,  // 123: ethereum.eth.v1alpha1.SignedBeaconBlockElectra.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockElectra
	45,  // 124: ethereum.eth.v1alpha1.BeaconBlockElectra.body:type_name -> ethereum.eth.v1alpha1.BeaconBlockBodyElectra
	15,  // 125: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	8,   // 126: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	10,  // 127: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashingElectra
	70,  // 128: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.attestations:type_name -> ethereum.eth.v1alpha1.AttestationElectra
	11,  // 129: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	13,  // 130: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	20,  // 131: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	14,  // 132: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.bail_outs:type_name -> ethereum.eth.v1alpha1.BailOut
	65,  // 133: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayloadDeneb
	66,  // 134: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.bls_to_execution_changes:type_name -> ethereum.eth.v1alpha1.SignedBLSToExecutionChange
	71,  // 135: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.execution_requests:type_name -> ethereum.engine.v1.ExecutionRequests
	47,  // 136: ethereum.eth.v1alpha1.SignedBlindedBeaconBlockElectra.message:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockElectra
	48,  // 137: ethereum.eth.v1alpha1.BlindedBeaconBlockElectra.body:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra
	15,  // 138: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	8,   // 139: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	10,  // 140: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashingElectra
	70,  // 141: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.attestations:type_name -> ethereum.eth.v1alpha1.AttestationElectra
	11,  // 142: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	13,  // 143: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	20,  // 144: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	14,  // 145: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.bail_outs:type_name -> ethereum.eth.v1alpha1.BailOut
	69,  // 146: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderDeneb
	66,  // 147: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.bls_to_execution_changes:type_name -> ethereum.eth.v1alpha1.SignedBLSToExecutionChange
	71,  // 148: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.execution_requests:type_name -> ethereum.engine.v1.ExecutionRequests
	51,  // 149: ethereum.eth.v1alpha1.SignedValidatorRegistrationsV1.messages:type_name -> ethereum.eth.v1alpha1.SignedValidatorRegistrationV1
	49,  // 150: ethereum.eth.v1alpha1.SignedValidatorRegistrationV1.message:type_name -> ethereum.eth.v1alpha1.ValidatorRegistrationV1
	64,  // 151: ethereum.eth.v1alpha1.BuilderBid.header:type_name -> ethereum.engine.v1.ExecutionPayloadHeader
	52,  // 152: ethereum.eth.v1alpha1.SignedBuilderBid.message:type_name -> ethereum.eth.v1alpha1.BuilderBid
	68,  // 153: ethereum.eth.v1alpha1.BuilderBidCapella.header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderCapella
	54,  // 154: ethereum.eth.v1alpha1.SignedBuilderBidCapella.message:type_name -> ethereum.eth.v1alpha1.BuilderBidCapella
	69,  // 155: ethereum.eth.v1alpha1.BuilderBidDeneb.header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderDeneb
	56,  // 156: ethereum.eth.v1alpha1.SignedBuilderBidDeneb.message:type_name -> ethereum.eth.v1alpha1.BuilderBidDeneb
	17,  // 157: ethereum.eth.v1alpha1.BlobSidecar.signed_block_header:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockHeader
	58,  // 158: ethereum.eth.v1alpha1.BlobSidecars.sidecars:type_name -> ethereum.eth.v1alpha1.BlobSidecar
