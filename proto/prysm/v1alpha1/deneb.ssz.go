...
// Hash: fc8849187a708ec60d4c71b27d570832d0346e63ec80278d0f655f6ab385d5ed
package eth
...
func (b *BeaconStateDeneb) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2621869:2646493]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[2646493:2671117]); err != nil {
		return err
	}

	// Offset (26) 'LatestExecutionPayloadHeader'
	if o26 = ssz.ReadOffset(buf[2671117:2671121]); o26 > size || o23 > o26 {
		return ssz.ErrOffset
	}

	// Field (27) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2671121:2671129])

	// Field (28) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2671129:2671137]))

	// Offset (29) 'HistoricalSummaries'
	if o29 = ssz.ReadOffset(buf[2671137:2671141]); o29 > size || o26 > o29 {
		return ssz.ErrOffset
	}
