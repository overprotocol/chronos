...
type SignRequest struct {
	...
	//	*SignRequest_BlockBadger
	//	*SignRequest_BlindedBlockBadger
...
func (x *SignRequest) GetBlockBadger() *v1alpha1.BeaconBlockBadger {
	if x, ok := x.GetObject().(*SignRequest_BlockBadger); ok {
		return x.BlockBadger
	}
	return nil
}

func (x *SignRequest) GetBlindedBlockBadger() *v1alpha1.BlindedBeaconBlockBadger {
	if x, ok := x.GetObject().(*SignRequest_BlindedBlockBadger); ok {
		return x.BlindedBlockBadger
	}
	return nil
}
...
type SignRequest_BlockBellatrix struct {
	BlockBellatrix *v1alpha1.BeaconBlockBellatrix `protobuf:"bytes,108,opt,name=block_bellatrix,json=blockBellatrix,proto3,oneof"`
}

type SignRequest_BlindedBlockBellatrix struct {
	BlindedBlockBellatrix *v1alpha1.BlindedBeaconBlockBellatrix `protobuf:"bytes,109,opt,name=blinded_block_bellatrix,json=blindedBlockBellatrix,proto3,oneof"`
}

type SignRequest_Registration struct {
	Registration *v1alpha1.ValidatorRegistrationV1 `protobuf:"bytes,110,opt,name=registration,proto3,oneof"`
}

type SignRequest_BlockCapella struct {
	BlockCapella *v1alpha1.BeaconBlockCapella `protobuf:"bytes,111,opt,name=block_capella,json=blockCapella,proto3,oneof"`
}

type SignRequest_BlindedBlockCapella struct {
	BlindedBlockCapella *v1alpha1.BlindedBeaconBlockCapella `protobuf:"bytes,112,opt,name=blinded_block_capella,json=blindedBlockCapella,proto3,oneof"`
}

type SignRequest_BlockDeneb struct {
	BlockDeneb *v1alpha1.BeaconBlockDeneb `protobuf:"bytes,113,opt,name=block_deneb,json=blockDeneb,proto3,oneof"`
}

type SignRequest_BlindedBlockDeneb struct {
	BlindedBlockDeneb *v1alpha1.BlindedBeaconBlockDeneb `protobuf:"bytes,114,opt,name=blinded_block_deneb,json=blindedBlockDeneb,proto3,oneof"`
}

type SignRequest_BlockElectra struct {
	BlockElectra *v1alpha1.BeaconBlockElectra `protobuf:"bytes,115,opt,name=block_electra,json=blockElectra,proto3,oneof"`
}

type SignRequest_BlindedBlockElectra struct {
	BlindedBlockElectra *v1alpha1.BlindedBeaconBlockElectra `protobuf:"bytes,116,opt,name=blinded_block_electra,json=blindedBlockElectra,proto3,oneof"`
}

type SignRequest_AggregateAttestationAndProofElectra struct {
	AggregateAttestationAndProofElectra *v1alpha1.AggregateAttestationAndProofElectra `protobuf:"bytes,117,opt,name=aggregate_attestation_and_proof_electra,json=aggregateAttestationAndProofElectra,proto3,oneof"`
}

type SignRequest_BlockBadger struct {
	BlockBadger *v1alpha1.BeaconBlockBadger `protobuf:"bytes,118,opt,name=block_badger,json=blockBadger,proto3,oneof"`
}

type SignRequest_BlindedBlockBadger struct {
	BlindedBlockBadger *v1alpha1.BlindedBeaconBlockBadger `protobuf:"bytes,119,opt,name=blinded_block_badger,json=blindedBlockBadger,proto3,oneof"`
}
...
func (*SignRequest_BlockBadger) isSignRequest_Object() {}

func (*SignRequest_BlindedBlockBadger) isSignRequest_Object() {}
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_rawDesc = []byte{
	...
	,
	...
	0x00, 0x52, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x53, 0x0a, 0x10, 0x61, 0x74, 0x74, 0x65,
	0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x66, 0x20, 0x01,
	...
	0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x48, 0x00, 0x52, 0x0f, 0x61, 0x74,
	0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x12, 0x7c, 0x0a,
	0x1f, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x5f, 0x61, 0x74, 0x74, 0x65, 0x73,
	0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x61, 0x6e, 0x64, 0x5f, 0x70, 0x72, 0x6f, 0x6f, 0x66,
	0x18, 0x67, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75,
	...
	,
	...
	0x73, 0x6c, 0x6f, 0x74, 0x12, 0x5e, 0x0a, 0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x18, 0x6a, 0x20,
	...
	0x61, 0x69, 0x72, 0x12, 0x56, 0x0a, 0x0f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x62, 0x65, 0x6c,
	0x6c, 0x61, 0x74, 0x72, 0x69, 0x78, 0x18, 0x6c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x65,
	...
	0x6c, 0x61, 0x74, 0x72, 0x69, 0x78, 0x18, 0x6d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x65,
	0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c,
	...
	0x69, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x6e, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x18, 0x6f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75,
	...
	0x63, 0x6b, 0x5f, 0x63, 0x61, 0x70, 0x65, 0x6c, 0x6c, 0x61, 0x18, 0x70, 0x20, 0x01, 0x28, 0x0b,
	...
	0x63, 0x6b, 0x5f, 0x64, 0x65, 0x6e, 0x65, 0x62, 0x18, 0x71, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27,
	...
	0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x64, 0x65, 0x6e, 0x65, 0x62, 0x18, 0x72, 0x20, 0x01,
	...
	0x5f, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x72, 0x61, 0x18, 0x73, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29,
	0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31,
	0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f,
	...
	0x72, 0x61, 0x18, 0x74, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72,
	...
	0x70, 0x72, 0x6f, 0x6f, 0x66, 0x5f, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x72, 0x61, 0x18, 0x75, 0x20,
	...
	0x6c, 0x65, 0x63, 0x74, 0x72, 0x61, 0x12, 0x4d, 0x0a, 0x0c, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f,
	0x62, 0x61, 0x64, 0x67, 0x65, 0x72, 0x18, 0x76, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x65,
	0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c,
	0x70, 0x68, 0x61, 0x31, 0x2e, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b,
	0x42, 0x61, 0x64, 0x67, 0x65, 0x72, 0x48, 0x00, 0x52, 0x0b, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x42,
	0x61, 0x64, 0x67, 0x65, 0x72, 0x12, 0x63, 0x0a, 0x14, 0x62, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64,
	0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x62, 0x61, 0x64, 0x67, 0x65, 0x72, 0x18, 0x77, 0x20,
	...
	0x64, 0x67, 0x65, 0x72, 0x48, 0x00, 0x52, 0x12, 0x62, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x42, 0x61, 0x64, 0x67, 0x65, 0x72, 0x12, 0x68, 0x0a, 0x0c, 0x73, 0x69,
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_goTypes = []interface{}{
	...
	(*v1alpha1.BeaconBlockBellatrix)(nil),                // 12: ethereum.eth.v1alpha1.BeaconBlockBellatrix
	(*v1alpha1.BlindedBeaconBlockBellatrix)(nil),         // 13: ethereum.eth.v1alpha1.BlindedBeaconBlockBellatrix
	(*v1alpha1.ValidatorRegistrationV1)(nil),             // 14: ethereum.eth.v1alpha1.ValidatorRegistrationV1
	(*v1alpha1.BeaconBlockCapella)(nil),                  // 15: ethereum.eth.v1alpha1.BeaconBlockCapella
	(*v1alpha1.BlindedBeaconBlockCapella)(nil),           // 16: ethereum.eth.v1alpha1.BlindedBeaconBlockCapella
	(*v1alpha1.BeaconBlockDeneb)(nil),                    // 17: ethereum.eth.v1alpha1.BeaconBlockDeneb
	(*v1alpha1.BlindedBeaconBlockDeneb)(nil),             // 18: ethereum.eth.v1alpha1.BlindedBeaconBlockDeneb
	(*v1alpha1.BeaconBlockElectra)(nil),                  // 19: ethereum.eth.v1alpha1.BeaconBlockElectra
	(*v1alpha1.BlindedBeaconBlockElectra)(nil),           // 20: ethereum.eth.v1alpha1.BlindedBeaconBlockElectra
	(*v1alpha1.AggregateAttestationAndProofElectra)(nil), // 21: ethereum.eth.v1alpha1.AggregateAttestationAndProofElectra
	(*v1alpha1.BeaconBlockBadger)(nil),                   // 22: ethereum.eth.v1alpha1.BeaconBlockBadger
	(*v1alpha1.BlindedBeaconBlockBadger)(nil),            // 23: ethereum.eth.v1alpha1.BlindedBeaconBlockBadger
}
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_depIdxs = []int32{
	...
	12, // 5: ethereum.validator.accounts.v2.SignRequest.block_bellatrix:type_name -> ethereum.eth.v1alpha1.BeaconBlockBellatrix
	13, // 6: ethereum.validator.accounts.v2.SignRequest.blinded_block_bellatrix:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockBellatrix
	14, // 7: ethereum.validator.accounts.v2.SignRequest.registration:type_name -> ethereum.eth.v1alpha1.ValidatorRegistrationV1
	15, // 8: ethereum.validator.accounts.v2.SignRequest.block_capella:type_name -> ethereum.eth.v1alpha1.BeaconBlockCapella
	16, // 9: ethereum.validator.accounts.v2.SignRequest.blinded_block_capella:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockCapella
	17, // 10: ethereum.validator.accounts.v2.SignRequest.block_deneb:type_name -> ethereum.eth.v1alpha1.BeaconBlockDeneb
	18, // 11: ethereum.validator.accounts.v2.SignRequest.blinded_block_deneb:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockDeneb
	19, // 12: ethereum.validator.accounts.v2.SignRequest.block_electra:type_name -> ethereum.eth.v1alpha1.BeaconBlockElectra
	20, // 13: ethereum.validator.accounts.v2.SignRequest.blinded_block_electra:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockElectra
	21, // 14: ethereum.validator.accounts.v2.SignRequest.aggregate_attestation_and_proof_electra:type_name -> ethereum.eth.v1alpha1.AggregateAttestationAndProofElectra
	22, // 15: ethereum.validator.accounts.v2.SignRequest.block_badger:type_name -> ethereum.eth.v1alpha1.BeaconBlockBadger
	23, // 16: ethereum.validator.accounts.v2.SignRequest.blinded_block_badger:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockBadger
	0,  // 17: ethereum.validator.accounts.v2.SignResponse.status:type_name -> ethereum.validator.accounts.v2.SignResponse.Status
	4,  // 18: ethereum.validator.accounts.v2.ProposerOptionPayload.builder:type_name -> ethereum.validator.accounts.v2.BuilderConfig
	...
	3,  // 20: ethereum.validator.accounts.v2.ProposerSettingsPayload.default_config:type_name -> ethereum.validator.accounts.v2.ProposerOptionPayload
	3,  // 21: ethereum.validator.accounts.v2.ProposerSettingsPayload.ProposerConfigEntry.value:type_name -> ethereum.validator.accounts.v2.ProposerOptionPayload
...
func file_proto_prysm_v1alpha1_validator_client_keymanager_proto_init() {
	...
	file_proto_prysm_v1alpha1_validator_client_keymanager_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*SignRequest_BlockBadger)(nil),
		(*SignRequest_BlindedBlockBadger)(nil),
	}
