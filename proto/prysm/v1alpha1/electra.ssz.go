...
// Hash: fe2f0051449cd8473c220900b7ca3d39817701008a33596cf34193f661a6cb6b
package eth
...
func (b *BeaconStateElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (38) 'PendingBalanceDeposits'
	dst = ssz.WriteOffset(dst, offset)
	...
	// Field (38) 'PendingBalanceDeposits'
...
func (b *BeaconStateElectra) UnmarshalSSZ(buf []byte) error {
	...
	// Field (36) 'ConsolidationBalanceToConsume'
	b.ConsolidationBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2736713:2736721]))

	// Field (37) 'EarliestConsolidationEpoch'
	b.EarliestConsolidationEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2736721:2736729]))
