...
// Hash: 111bbc0cadf4aaffa92421591ab42b64c0c89adf69838c7dea79d91129294702
package eth
...
func (b *BeaconStateElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o10, o12, o13, o17, o18, o23, o26, o29, o34, o35 uint64
	...
	// Field (30) 'DepositRequestsStartIndex'
	b.DepositRequestsStartIndex = ssz.UnmarshallUint64(buf[2671141:2671149])

	// Field (31) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2671149:2671157]))

	// Field (32) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2671157:2671165]))

	// Field (33) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2671165:2671173]))

	// Offset (34) 'PendingDeposits'
	if o34 = ssz.ReadOffset(buf[2671173:2671177]); o34 > size || o29 > o34 {
		return ssz.ErrOffset
	}

	// Offset (35) 'PendingPartialWithdrawals'
	if o35 = ssz.ReadOffset(buf[2671177:2671181]); o35 > size || o34 > o35 {
		return ssz.ErrOffset
	}
