...
// Hash: 02cf9ae3a23f76bd9bfe2aabf6a5823cc3be442e2335c0046cf832a2baba7f78
package eth
...
func (b *BeaconStateElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o10, o12, o13, o16, o17, o22, o25, o28, o33, o34 uint64
	...
	for ii := 0; ii < 65536; ii++ {
		if cap(b.RandaoMixes[ii]) == 0 {
			b.RandaoMixes[ii] = make([]byte, 0, len(buf[524576:2621728][ii*32:(ii+1)*32]))
		}
		b.RandaoMixes[ii] = append(b.RandaoMixes[ii], buf[524576:2621728][ii*32:(ii+1)*32]...)
	}
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2621861:2646485]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[2646485:2671109]); err != nil {
		return err
	}

	// Offset (25) 'LatestExecutionPayloadHeader'
	if o25 = ssz.ReadOffset(buf[2671109:2671113]); o25 > size || o22 > o25 {
		return ssz.ErrOffset
	}

	// Field (26) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2671113:2671121])

	// Field (27) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2671121:2671129]))

	// Offset (28) 'HistoricalSummaries'
	if o28 = ssz.ReadOffset(buf[2671129:2671133]); o28 > size || o25 > o28 {
		return ssz.ErrOffset
	}

	// Field (29) 'DepositRequestsStartIndex'
	b.DepositRequestsStartIndex = ssz.UnmarshallUint64(buf[2671133:2671141])

	// Field (30) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2671141:2671149]))

	// Field (31) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2671149:2671157]))

	// Field (32) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2671157:2671165]))

	// Offset (33) 'PendingDeposits'
	if o33 = ssz.ReadOffset(buf[2671165:2671169]); o33 > size || o28 > o33 {
		return ssz.ErrOffset
	}

	// Offset (34) 'PendingPartialWithdrawals'
	if o34 = ssz.ReadOffset(buf[2671169:2671173]); o34 > size || o33 > o34 {
		return ssz.ErrOffset
	}
...
func (b *BeaconStateOldElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o9, o11, o12, o14, o15, o20, o23, o26, o31, o32 uint64
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2621845:2646469]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[2646469:2671093]); err != nil {
		return err
	}

	// Offset (23) 'LatestExecutionPayloadHeader'
	if o23 = ssz.ReadOffset(buf[2671093:2671097]); o23 > size || o20 > o23 {
		return ssz.ErrOffset
	}

	// Field (24) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2671097:2671105])

	// Field (25) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2671105:2671113]))

	// Offset (26) 'HistoricalSummaries'
	if o26 = ssz.ReadOffset(buf[2671113:2671117]); o26 > size || o23 > o26 {
		return ssz.ErrOffset
	}

	// Field (27) 'DepositRequestsStartIndex'
	b.DepositRequestsStartIndex = ssz.UnmarshallUint64(buf[2671117:2671125])

	// Field (28) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2671125:2671133]))

	// Field (29) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2671133:2671141]))

	// Field (30) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2671141:2671149]))

	// Offset (31) 'PendingDeposits'
	if o31 = ssz.ReadOffset(buf[2671149:2671153]); o31 > size || o26 > o31 {
		return ssz.ErrOffset
	}

	// Offset (32) 'PendingPartialWithdrawals'
	if o32 = ssz.ReadOffset(buf[2671153:2671157]); o32 > size || o31 > o32 {
		return ssz.ErrOffset
	}
