...
// Hash: 7e34c7daa3a7901a777dd02b346af14e377fcfc5a2bc81e78737f24904ebf84e
package eth
...
func (b *BeaconBlockBodyElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (11) 'BlsToExecutionChanges'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.BlsToExecutionChanges) * 172

	// Offset (12) 'BlobKzgCommitments'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.BlobKzgCommitments) * 48

	// Offset (13) 'ExecutionRequests'
	dst = ssz.WriteOffset(dst, offset)
	...
	// Field (10) 'ExecutionPayload'
	if dst, err = b.ExecutionPayload.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (11) 'BlsToExecutionChanges'
...
func (b *BeaconBlockBodyElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o3, o4, o5, o6, o7, o9, o10, o11, o12, o13 uint64
	...
	// Offset (13) 'ExecutionRequests'
	if o13 = ssz.ReadOffset(buf[396:400]); o13 > size || o12 > o13 {
		return ssz.ErrOffset
	}
...
func (b *BlindedBeaconBlockBodyElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (10) 'ExecutionPayloadHeader'
	dst = ssz.WriteOffset(dst, offset)
	...
	// Field (10) 'ExecutionPayloadHeader'
...
func (b *BeaconStateElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o10, o12, o13, o18, o19, o24, o27, o28, o31, o36, o37 uint64
	...
	// Field (30) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2736669:2736677]))
	...
	// Field (33) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2736689:2736697]))

	// Field (34) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2736697:2736705]))

	// Field (35) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2736705:2736713]))

	// Offset (36) 'PendingBalanceDeposits'
	if o36 = ssz.ReadOffset(buf[2736713:2736717]); o36 > size || o31 > o36 {
		return ssz.ErrOffset
	}

	// Offset (37) 'PendingPartialWithdrawals'
	if o37 = ssz.ReadOffset(buf[2736717:2736721]); o37 > size || o36 > o37 {
		return ssz.ErrOffset
	}
...
func (b *BeaconStateOldElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o9, o11, o12, o15, o16, o21, o24, o27, o32, o33 uint64
	...
	// Offset (32) 'PendingBalanceDeposits'
	if o32 = ssz.ReadOffset(buf[2736685:2736689]); o32 > size || o27 > o32 {
		return ssz.ErrOffset
	}

	// Offset (33) 'PendingPartialWithdrawals'
	if o33 = ssz.ReadOffset(buf[2736689:2736693]); o33 > size || o32 > o33 {
		return ssz.ErrOffset
	}
