...
// Hash: a1e66fb5468038c8391f3110f0424df6808b5b88cbdbf526450eb85bd6d09595
package eth
...
func (b *BeaconStateElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (27) 'LatestExecutionPayloadHeader'
	dst = ssz.WriteOffset(dst, offset)
	...
	// Field (37) 'PendingBalanceDeposits'
...
func (b *BeaconStateElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o10, o12, o13, o18, o19, o24, o27, o30, o37, o38, o39 uint64
	...
	// Field (28) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2736657:2736665])

	// Field (29) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2736665:2736673]))

	// Offset (30) 'HistoricalSummaries'
	if o30 = ssz.ReadOffset(buf[2736673:2736677]); o30 > size || o27 > o30 {
		return ssz.ErrOffset
	}

	// Field (31) 'DepositRequestsStartIndex'
	b.DepositRequestsStartIndex = ssz.UnmarshallUint64(buf[2736677:2736685])

	// Field (32) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2736685:2736693]))

	// Field (33) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2736693:2736701]))

	// Field (34) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2736701:2736709]))

	// Field (35) 'ConsolidationBalanceToConsume'
	b.ConsolidationBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2736709:2736717]))

	// Field (36) 'EarliestConsolidationEpoch'
	b.EarliestConsolidationEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2736717:2736725]))

	// Offset (37) 'PendingBalanceDeposits'
	if o37 = ssz.ReadOffset(buf[2736725:2736729]); o37 > size || o30 > o37 {
		return ssz.ErrOffset
	}

	// Offset (38) 'PendingPartialWithdrawals'
	if o38 = ssz.ReadOffset(buf[2736729:2736733]); o38 > size || o37 > o38 {
		return ssz.ErrOffset
	}
