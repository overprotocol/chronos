...
// Hash: 3577056baa498a2562271abc77bad274ce6a6d00032c9d630d977d86f0061c2b
package eth
...
func (b *BeaconStateElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (35) 'PendingDeposits'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.PendingDeposits) * 192

	// Offset (36) 'PendingPartialWithdrawals'
	dst = ssz.WriteOffset(dst, offset)
	...
	// Field (36) 'PendingPartialWithdrawals'
...
func (b *BeaconStateElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o10, o12, o13, o18, o19, o24, o27, o30, o35, o36 uint64
	...
	// Offset (35) 'PendingDeposits'
	if o35 = ssz.ReadOffset(buf[2736709:2736713]); o35 > size || o30 > o35 {
		return ssz.ErrOffset
	}

	// Offset (36) 'PendingPartialWithdrawals'
	if o36 = ssz.ReadOffset(buf[2736713:2736717]); o36 > size || o35 > o36 {
		return ssz.ErrOffset
	}
