...
// Hash: 71c9701fc1d5d411cefa66bc0e8815c53db4508bbf6314abf3c1907e8f94f259
package eth
...
func (b *BeaconBlockBodyElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o3, o4, o5, o6, o7, o8, o9, o10, o11 uint64
	...
	// Offset (11) 'ExecutionRequests'
	if o11 = ssz.ReadOffset(buf[232:236]); o11 > size || o10 > o11 {
		return ssz.ErrOffset
	}
...
func (b *BeaconStateElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (30) 'PendingDeposits'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.PendingDeposits) * 192

	// Offset (31) 'PendingPartialWithdrawals'
	dst = ssz.WriteOffset(dst, offset)
	...
	// Field (31) 'PendingPartialWithdrawals'
...
func (b *BeaconStateElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o9, o11, o12, o15, o16, o21, o22, o25, o30, o31 uint64
	...
	// Field (26) 'DepositRequestsStartIndex'
	b.DepositRequestsStartIndex = ssz.UnmarshallUint64(buf[2621881:2621889])

	// Field (27) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2621889:2621897]))

	// Field (28) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2621897:2621905]))

	// Field (29) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2621905:2621913]))

	// Offset (30) 'PendingDeposits'
	if o30 = ssz.ReadOffset(buf[2621913:2621917]); o30 > size || o25 > o30 {
		return ssz.ErrOffset
	}

	// Offset (31) 'PendingPartialWithdrawals'
	if o31 = ssz.ReadOffset(buf[2621917:2621921]); o31 > size || o30 > o31 {
		return ssz.ErrOffset
	}
...
func (b *BeaconStateOldElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (24) 'DepositRequestsStartIndex'
	dst = ssz.MarshalUint64(dst, b.DepositRequestsStartIndex)

	// Field (25) 'DepositBalanceToConsume'
	dst = ssz.MarshalUint64(dst, uint64(b.DepositBalanceToConsume))

	// Field (26) 'ExitBalanceToConsume'
	dst = ssz.MarshalUint64(dst, uint64(b.ExitBalanceToConsume))

	// Field (27) 'EarliestExitEpoch'
	dst = ssz.MarshalUint64(dst, uint64(b.EarliestExitEpoch))

	// Offset (28) 'PendingDeposits'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.PendingDeposits) * 192

	// Offset (29) 'PendingPartialWithdrawals'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.PendingPartialWithdrawals) * 24
	...
	// Field (29) 'PendingPartialWithdrawals'
	if size := len(b.PendingPartialWithdrawals); size > 134217728 {
		err = ssz.ErrListTooBigFn("--.PendingPartialWithdrawals", size, 134217728)
		return
	}
...
func (b *BeaconStateOldElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o8, o10, o11, o13, o14, o19, o20, o23, o28, o29 uint64
	...
	// Field (24) 'DepositRequestsStartIndex'
	b.DepositRequestsStartIndex = ssz.UnmarshallUint64(buf[2621865:2621873])

	// Field (25) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2621873:2621881]))

	// Field (26) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2621881:2621889]))

	// Field (27) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2621889:2621897]))

	// Offset (28) 'PendingDeposits'
	if o28 = ssz.ReadOffset(buf[2621897:2621901]); o28 > size || o23 > o28 {
		return ssz.ErrOffset
	}

	// Offset (29) 'PendingPartialWithdrawals'
	if o29 = ssz.ReadOffset(buf[2621901:2621905]); o29 > size || o28 > o29 {
		return ssz.ErrOffset
	}
