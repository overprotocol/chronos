...
// Hash: 98a4fa97a73de4e38f38095525284abeaa718d83a29342d1a18968ac1727d27b
package eth
...
func (b *BeaconStateElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o10, o12, o13, o17, o18, o23, o26, o29, o36, o37, o38 uint64
	...
	for ii := 0; ii < 8192; ii++ {
		b.Slashings[ii] = ssz.UnmarshallUint64(buf[2621728:2687264][ii*8 : (ii+1)*8])
	}

	// Offset (17) 'PreviousEpochParticipation'
	if o17 = ssz.ReadOffset(buf[2687264:2687268]); o17 > size || o13 > o17 {
		return ssz.ErrOffset
	}

	// Offset (18) 'CurrentEpochParticipation'
	if o18 = ssz.ReadOffset(buf[2687268:2687272]); o18 > size || o17 > o18 {
		return ssz.ErrOffset
	}

	// Field (19) 'JustificationBits'
	if cap(b.JustificationBits) == 0 {
		b.JustificationBits = make([]byte, 0, len(buf[2687272:2687273]))
	}
	b.JustificationBits = append(b.JustificationBits, buf[2687272:2687273]...)

	// Field (20) 'PreviousJustifiedCheckpoint'
	if b.PreviousJustifiedCheckpoint == nil {
		b.PreviousJustifiedCheckpoint = new(Checkpoint)
	}
	if err = b.PreviousJustifiedCheckpoint.UnmarshalSSZ(buf[2687273:2687313]); err != nil {
		return err
	}
	...
	if err = b.CurrentJustifiedCheckpoint.UnmarshalSSZ(buf[2687313:2687353]); err != nil {
		return err
	}
	...
	if err = b.FinalizedCheckpoint.UnmarshalSSZ(buf[2687353:2687393]); err != nil {
		return err
	}

	// Offset (23) 'InactivityScores'
	if o23 = ssz.ReadOffset(buf[2687393:2687397]); o23 > size || o18 > o23 {
		return ssz.ErrOffset
	}
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2687397:2712021]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[2712021:2736645]); err != nil {
		return err
	}

	// Offset (26) 'LatestExecutionPayloadHeader'
	if o26 = ssz.ReadOffset(buf[2736645:2736649]); o26 > size || o23 > o26 {
		return ssz.ErrOffset
	}

	// Field (27) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2736649:2736657])

	// Field (28) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2736657:2736665]))

	// Offset (29) 'HistoricalSummaries'
	if o29 = ssz.ReadOffset(buf[2736665:2736669]); o29 > size || o26 > o29 {
		return ssz.ErrOffset
	}

	// Field (30) 'DepositRequestsStartIndex'
	b.DepositRequestsStartIndex = ssz.UnmarshallUint64(buf[2736669:2736677])

	// Field (31) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2736677:2736685]))

	// Field (32) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2736685:2736693]))

	// Field (33) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2736693:2736701]))

	// Field (34) 'ConsolidationBalanceToConsume'
	b.ConsolidationBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2736701:2736709]))

	// Field (35) 'EarliestConsolidationEpoch'
	b.EarliestConsolidationEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2736709:2736717]))

	// Offset (36) 'PendingDeposits'
	if o36 = ssz.ReadOffset(buf[2736717:2736721]); o36 > size || o29 > o36 {
		return ssz.ErrOffset
	}

	// Offset (37) 'PendingPartialWithdrawals'
	if o37 = ssz.ReadOffset(buf[2736721:2736725]); o37 > size || o36 > o37 {
		return ssz.ErrOffset
	}

	// Offset (38) 'PendingConsolidations'
	if o38 = ssz.ReadOffset(buf[2736725:2736729]); o38 > size || o37 > o38 {
		return ssz.ErrOffset
	}
