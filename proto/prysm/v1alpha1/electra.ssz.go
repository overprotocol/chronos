...
// Hash: 236535b56fe0f5fa610ecde2d8351c3514eaaeabfee5ded0232625d5cb49a645
package eth
...
func (b *BeaconBlockBodyElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (8) 'BailOuts'
	if size := len(b.BailOuts); size > 16 {
		err = ssz.ErrListTooBigFn("--.BailOuts", size, 16)
		return
	}
	for ii := 0; ii < len(b.BailOuts); ii++ {
		if dst, err = b.BailOuts[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}
...
func (b *BeaconBlockBodyElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o3, o4, o5, o6, o7, o8, o9, o10, o11, o12 uint64
	...
	// Offset (12) 'ExecutionRequests'
	if o12 = ssz.ReadOffset(buf[236:240]); o12 > size || o11 > o12 {
		return ssz.ErrOffset
	}
	...
	// Field (8) 'BailOuts'
	{
		...
		b.BailOuts = make([]*BailOut, num)
		for ii := 0; ii < num; ii++ {
			if b.BailOuts[ii] == nil {
				b.BailOuts[ii] = new(BailOut)
			}
			if err = b.BailOuts[ii].UnmarshalSSZ(buf[ii*8 : (ii+1)*8]); err != nil {
				return err
			}
		}
	}
...
func (b *BeaconBlockBodyElectra) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	{
		subIndx := hh.Index()
		num := uint64(len(b.BailOuts))
		if num > 16 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for _, elem := range b.BailOuts {
			if err = elem.HashTreeRootWith(hh); err != nil {
				return
			}
		}
...
func (b *BeaconStateElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (25) 'BailOutScores'
	if size := len(b.BailOutScores); size > 1099511627776 {
		err = ssz.ErrListTooBigFn("--.BailOutScores", size, 1099511627776)
		return
	}
	...
	// Field (36) 'PendingBalanceDeposits'
	...
	// Field (37) 'PendingPartialWithdrawals'
	...
	// Field (38) 'PendingConsolidations'
...
func (b *BeaconStateElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o10, o12, o13, o18, o19, o24, o25, o26, o29, o36, o37, o38 uint64
	...
	for ii := 0; ii < 65536; ii++ {
		if cap(b.RandaoMixes[ii]) == 0 {
			b.RandaoMixes[ii] = make([]byte, 0, len(buf[524584:2621736][ii*32:(ii+1)*32]))
		}
		b.RandaoMixes[ii] = append(b.RandaoMixes[ii], buf[524584:2621736][ii*32:(ii+1)*32]...)
	}

	// Field (17) 'Slashings'
	b.Slashings = ssz.ExtendUint64(b.Slashings, 8192)
	for ii := 0; ii < 8192; ii++ {
		b.Slashings[ii] = ssz.UnmarshallUint64(buf[2621736:2687272][ii*8 : (ii+1)*8])
	}
	...
	// Offset (25) 'BailOutScores'
	if o25 = ssz.ReadOffset(buf[2687405:2687409]); o25 > size || o24 > o25 {
		return ssz.ErrOffset
	}

	// Offset (26) 'LatestExecutionPayloadHeader'
	if o26 = ssz.ReadOffset(buf[2687409:2687413]); o26 > size || o25 > o26 {
		return ssz.ErrOffset
	}

	// Field (27) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2687413:2687421])

	// Field (28) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2687421:2687429]))

	// Offset (29) 'HistoricalSummaries'
	if o29 = ssz.ReadOffset(buf[2687429:2687433]); o29 > size || o26 > o29 {
		return ssz.ErrOffset
	}

	// Field (30) 'DepositRequestsStartIndex'
	b.DepositRequestsStartIndex = ssz.UnmarshallUint64(buf[2687433:2687441])

	// Field (31) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2687441:2687449]))

	// Field (32) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2687449:2687457]))

	// Field (33) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2687457:2687465]))

	// Field (34) 'ConsolidationBalanceToConsume'
	b.ConsolidationBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2687465:2687473]))

	// Field (35) 'EarliestConsolidationEpoch'
	b.EarliestConsolidationEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2687473:2687481]))

	// Offset (36) 'PendingBalanceDeposits'
	if o36 = ssz.ReadOffset(buf[2687481:2687485]); o36 > size || o29 > o36 {
		return ssz.ErrOffset
	}

	// Offset (37) 'PendingPartialWithdrawals'
	if o37 = ssz.ReadOffset(buf[2687485:2687489]); o37 > size || o36 > o37 {
		return ssz.ErrOffset
	}

	// Offset (38) 'PendingConsolidations'
	if o38 = ssz.ReadOffset(buf[2687489:2687493]); o38 > size || o37 > o38 {
		return ssz.ErrOffset
	}
...
func (b *BeaconStateOldElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (32) 'PendingBalanceDeposits'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.PendingBalanceDeposits) * 16

	// Offset (33) 'PendingPartialWithdrawals'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.PendingPartialWithdrawals) * 24

	// Offset (34) 'PendingConsolidations'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.PendingConsolidations) * 16
	...
	// Field (32) 'PendingBalanceDeposits'
	if size := len(b.PendingBalanceDeposits); size > 134217728 {
		err = ssz.ErrListTooBigFn("--.PendingBalanceDeposits", size, 134217728)
		return
	}
...
func (b *BeaconStateOldElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o9, o11, o12, o15, o16, o21, o22, o25, o32, o33, o34 uint64
	...
	// Field (23) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2687385:2687393])

	// Field (24) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2687393:2687401]))

	// Offset (25) 'HistoricalSummaries'
	if o25 = ssz.ReadOffset(buf[2687401:2687405]); o25 > size || o22 > o25 {
		return ssz.ErrOffset
	}

	// Field (26) 'DepositRequestsStartIndex'
	b.DepositRequestsStartIndex = ssz.UnmarshallUint64(buf[2687405:2687413])

	// Field (27) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2687413:2687421]))

	// Field (28) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2687421:2687429]))

	// Field (29) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2687429:2687437]))

	// Field (30) 'ConsolidationBalanceToConsume'
	b.ConsolidationBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2687437:2687445]))

	// Field (31) 'EarliestConsolidationEpoch'
	b.EarliestConsolidationEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2687445:2687453]))

	// Offset (32) 'PendingBalanceDeposits'
	if o32 = ssz.ReadOffset(buf[2687453:2687457]); o32 > size || o25 > o32 {
		return ssz.ErrOffset
	}

	// Offset (33) 'PendingPartialWithdrawals'
	if o33 = ssz.ReadOffset(buf[2687457:2687461]); o33 > size || o32 > o33 {
		return ssz.ErrOffset
	}

	// Offset (34) 'PendingConsolidations'
	if o34 = ssz.ReadOffset(buf[2687461:2687465]); o34 > size || o33 > o34 {
		return ssz.ErrOffset
	}
