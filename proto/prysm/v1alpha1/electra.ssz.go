...
// Hash: e4da2aa617248e1740052f4bae21cdba4d8caf9a55947db030310547c4efafee
package eth
...
func (b *BeaconStateElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o10, o12, o13, o17, o18, o23, o24, o27, o32, o33 uint64
	...
	// Offset (17) 'PreviousEpochParticipation'
	if o17 = ssz.ReadOffset(buf[2621736:2621740]); o17 > size || o13 > o17 {
		return ssz.ErrOffset
	}

	// Offset (18) 'CurrentEpochParticipation'
	if o18 = ssz.ReadOffset(buf[2621740:2621744]); o18 > size || o17 > o18 {
		return ssz.ErrOffset
	}

	// Field (19) 'JustificationBits'
	if cap(b.JustificationBits) == 0 {
		b.JustificationBits = make([]byte, 0, len(buf[2621744:2621745]))
	}
	b.JustificationBits = append(b.JustificationBits, buf[2621744:2621745]...)

	// Field (20) 'PreviousJustifiedCheckpoint'
	if b.PreviousJustifiedCheckpoint == nil {
		b.PreviousJustifiedCheckpoint = new(Checkpoint)
	}
	if err = b.PreviousJustifiedCheckpoint.UnmarshalSSZ(buf[2621745:2621785]); err != nil {
		return err
	}
	...
	if err = b.CurrentJustifiedCheckpoint.UnmarshalSSZ(buf[2621785:2621825]); err != nil {
		return err
	}
	...
	if err = b.FinalizedCheckpoint.UnmarshalSSZ(buf[2621825:2621865]); err != nil {
		return err
	}

	// Offset (23) 'InactivityScores'
	if o23 = ssz.ReadOffset(buf[2621865:2621869]); o23 > size || o18 > o23 {
		return ssz.ErrOffset
	}

	// Offset (24) 'LatestExecutionPayloadHeader'
	if o24 = ssz.ReadOffset(buf[2621869:2621873]); o24 > size || o23 > o24 {
		return ssz.ErrOffset
	}

	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2621873:2621881])

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2621881:2621889]))

	// Offset (27) 'HistoricalSummaries'
	if o27 = ssz.ReadOffset(buf[2621889:2621893]); o27 > size || o24 > o27 {
		return ssz.ErrOffset
	}

	// Field (28) 'DepositRequestsStartIndex'
	b.DepositRequestsStartIndex = ssz.UnmarshallUint64(buf[2621893:2621901])

	// Field (29) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2621901:2621909]))

	// Field (30) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2621909:2621917]))

	// Field (31) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2621917:2621925]))

	// Offset (32) 'PendingDeposits'
	if o32 = ssz.ReadOffset(buf[2621925:2621929]); o32 > size || o27 > o32 {
		return ssz.ErrOffset
	}

	// Offset (33) 'PendingPartialWithdrawals'
	if o33 = ssz.ReadOffset(buf[2621929:2621933]); o33 > size || o32 > o33 {
		return ssz.ErrOffset
	}
...
func (b *BeaconStateOldElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (14) 'PreviousEpochParticipation'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.PreviousEpochParticipation)

	// Offset (15) 'CurrentEpochParticipation'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.CurrentEpochParticipation)
	...
	// Offset (20) 'InactivityScores'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.InactivityScores) * 8

	// Offset (21) 'LatestExecutionPayloadHeader'
	dst = ssz.WriteOffset(dst, offset)
	if b.LatestExecutionPayloadHeader == nil {
		b.LatestExecutionPayloadHeader = new(v1.ExecutionPayloadHeaderDeneb)
	}
	...
	// Field (22) 'NextWithdrawalIndex'
	dst = ssz.MarshalUint64(dst, b.NextWithdrawalIndex)

	// Field (23) 'NextWithdrawalValidatorIndex'
	dst = ssz.MarshalUint64(dst, uint64(b.NextWithdrawalValidatorIndex))

	// Offset (24) 'HistoricalSummaries'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.HistoricalSummaries) * 64

	// Field (25) 'DepositRequestsStartIndex'
	dst = ssz.MarshalUint64(dst, b.DepositRequestsStartIndex)

	// Field (26) 'DepositBalanceToConsume'
	dst = ssz.MarshalUint64(dst, uint64(b.DepositBalanceToConsume))

	// Field (27) 'ExitBalanceToConsume'
	dst = ssz.MarshalUint64(dst, uint64(b.ExitBalanceToConsume))

	// Field (28) 'EarliestExitEpoch'
	dst = ssz.MarshalUint64(dst, uint64(b.EarliestExitEpoch))

	// Offset (29) 'PendingDeposits'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.PendingDeposits) * 192

	// Offset (30) 'PendingPartialWithdrawals'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.PendingPartialWithdrawals) * 24
	...
	// Field (14) 'PreviousEpochParticipation'
	if size := len(b.PreviousEpochParticipation); size > 1099511627776 {
		err = ssz.ErrBytesLengthFn("--.PreviousEpochParticipation", size, 1099511627776)
		return
	}
	...
	// Field (15) 'CurrentEpochParticipation'
	if size := len(b.CurrentEpochParticipation); size > 1099511627776 {
		err = ssz.ErrBytesLengthFn("--.CurrentEpochParticipation", size, 1099511627776)
		return
	}
	...
	// Field (30) 'PendingPartialWithdrawals'
	if size := len(b.PendingPartialWithdrawals); size > 134217728 {
		err = ssz.ErrListTooBigFn("--.PendingPartialWithdrawals", size, 134217728)
		return
	}
...
func (b *BeaconStateOldElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o9, o11, o12, o14, o15, o20, o21, o24, o29, o30 uint64
	...
	// Offset (14) 'PreviousEpochParticipation'
	if o14 = ssz.ReadOffset(buf[2621712:2621716]); o14 > size || o12 > o14 {
		return ssz.ErrOffset
	}

	// Offset (15) 'CurrentEpochParticipation'
	if o15 = ssz.ReadOffset(buf[2621716:2621720]); o15 > size || o14 > o15 {
		return ssz.ErrOffset
	}

	// Field (16) 'JustificationBits'
	if cap(b.JustificationBits) == 0 {
		b.JustificationBits = make([]byte, 0, len(buf[2621720:2621721]))
	}
	b.JustificationBits = append(b.JustificationBits, buf[2621720:2621721]...)

	// Field (17) 'PreviousJustifiedCheckpoint'
	if b.PreviousJustifiedCheckpoint == nil {
		b.PreviousJustifiedCheckpoint = new(Checkpoint)
	}
	if err = b.PreviousJustifiedCheckpoint.UnmarshalSSZ(buf[2621721:2621761]); err != nil {
		return err
	}
	...
	if err = b.CurrentJustifiedCheckpoint.UnmarshalSSZ(buf[2621761:2621801]); err != nil {
		return err
	}
	...
	if err = b.FinalizedCheckpoint.UnmarshalSSZ(buf[2621801:2621841]); err != nil {
		return err
	}

	// Offset (20) 'InactivityScores'
	if o20 = ssz.ReadOffset(buf[2621841:2621845]); o20 > size || o15 > o20 {
		return ssz.ErrOffset
	}

	// Offset (21) 'LatestExecutionPayloadHeader'
	if o21 = ssz.ReadOffset(buf[2621845:2621849]); o21 > size || o20 > o21 {
		return ssz.ErrOffset
	}

	// Field (22) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2621849:2621857])

	// Field (23) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2621857:2621865]))

	// Offset (24) 'HistoricalSummaries'
	if o24 = ssz.ReadOffset(buf[2621865:2621869]); o24 > size || o21 > o24 {
		return ssz.ErrOffset
	}

	// Field (25) 'DepositRequestsStartIndex'
	b.DepositRequestsStartIndex = ssz.UnmarshallUint64(buf[2621869:2621877])

	// Field (26) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2621877:2621885]))

	// Field (27) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2621885:2621893]))

	// Field (28) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2621893:2621901]))

	// Offset (29) 'PendingDeposits'
	if o29 = ssz.ReadOffset(buf[2621901:2621905]); o29 > size || o24 > o29 {
		return ssz.ErrOffset
	}

	// Offset (30) 'PendingPartialWithdrawals'
	if o30 = ssz.ReadOffset(buf[2621905:2621909]); o30 > size || o29 > o30 {
		return ssz.ErrOffset
	}
