...
// Hash: 60d160c56184a9aec9d9b34e599d8a027a5bc3d6f4fd254aa2a70677674897d3
package eth
...
func (b *BeaconBlockBodyElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o2, o3, o4, o5, o7, o8, o9 uint64
	...
	if err = b.SyncAggregate.UnmarshalSSZ(buf[144:304]); err != nil {
		return err
	}

	// Offset (7) 'ExecutionPayload'
	if o7 = ssz.ReadOffset(buf[304:308]); o7 > size || o5 > o7 {
		return ssz.ErrOffset
	}

	// Offset (8) 'BlobKzgCommitments'
	if o8 = ssz.ReadOffset(buf[308:312]); o8 > size || o7 > o8 {
		return ssz.ErrOffset
	}

	// Offset (9) 'ExecutionRequests'
	if o9 = ssz.ReadOffset(buf[312:316]); o9 > size || o8 > o9 {
		return ssz.ErrOffset
	}
...
func (b *BlindedBeaconBlockBodyElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (7) 'ExecutionPayloadHeader'
	dst = ssz.WriteOffset(dst, offset)
	...
	// Field (7) 'ExecutionPayloadHeader'
...
func (b *BeaconStateElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (11) 'PreviousEpochReserve'
	dst = ssz.MarshalUint64(dst, b.PreviousEpochReserve)

	// Field (12) 'CurrentEpochReserve'
...
func (b *BeaconStateElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o9, o10, o15, o16, o21, o24, o27, o31, o32 uint64
	...
	// Offset (9) 'Validators'
	if o9 = ssz.ReadOffset(buf[524476:524480]); o9 > size || o7 > o9 {
		return ssz.ErrOffset
	}

	// Offset (10) 'Balances'
	if o10 = ssz.ReadOffset(buf[524480:524484]); o10 > size || o9 > o10 {
		return ssz.ErrOffset
	}

	// Field (11) 'PreviousEpochReserve'
	b.PreviousEpochReserve = ssz.UnmarshallUint64(buf[524484:524492])

	// Field (12) 'CurrentEpochReserve'
	b.CurrentEpochReserve = ssz.UnmarshallUint64(buf[524492:524500])
	...
	// Offset (15) 'PreviousEpochParticipation'
	if o15 = ssz.ReadOffset(buf[2687188:2687192]); o15 > size || o10 > o15 {
		return ssz.ErrOffset
	}

	// Offset (16) 'CurrentEpochParticipation'
	if o16 = ssz.ReadOffset(buf[2687192:2687196]); o16 > size || o15 > o16 {
		return ssz.ErrOffset
	}
	...
	// Offset (21) 'InactivityScores'
	if o21 = ssz.ReadOffset(buf[2687317:2687321]); o21 > size || o16 > o21 {
		return ssz.ErrOffset
	}
	...
	// Offset (24) 'LatestExecutionPayloadHeader'
	if o24 = ssz.ReadOffset(buf[2736569:2736573]); o24 > size || o21 > o24 {
		return ssz.ErrOffset
	}

	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2736573:2736581])

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2736581:2736589]))

	// Offset (27) 'HistoricalSummaries'
	if o27 = ssz.ReadOffset(buf[2736589:2736593]); o27 > size || o24 > o27 {
		return ssz.ErrOffset
	}

	// Field (28) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2736593:2736601]))

	// Field (29) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2736601:2736609]))

	// Field (30) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2736609:2736617]))

	// Offset (31) 'PendingDeposits'
	if o31 = ssz.ReadOffset(buf[2736617:2736621]); o31 > size || o27 > o31 {
		return ssz.ErrOffset
	}

	// Offset (32) 'PendingPartialWithdrawals'
	if o32 = ssz.ReadOffset(buf[2736621:2736625]); o32 > size || o31 > o32 {
		return ssz.ErrOffset
	}
...
func (b *BeaconStateOldElectra) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o8, o9, o12, o13, o18, o21, o24, o28, o29 uint64
	...
	for ii := 0; ii < 65536; ii++ {
		if cap(b.RandaoMixes[ii]) == 0 {
			b.RandaoMixes[ii] = make([]byte, 0, len(buf[524476:2621628][ii*32:(ii+1)*32]))
		}
		b.RandaoMixes[ii] = append(b.RandaoMixes[ii], buf[524476:2621628][ii*32:(ii+1)*32]...)
	}

	// Field (11) 'Slashings'
	b.Slashings = ssz.ExtendUint64(b.Slashings, 8192)
	for ii := 0; ii < 8192; ii++ {
		b.Slashings[ii] = ssz.UnmarshallUint64(buf[2621628:2687164][ii*8 : (ii+1)*8])
	}

	// Offset (12) 'PreviousEpochParticipation'
	if o12 = ssz.ReadOffset(buf[2687164:2687168]); o12 > size || o9 > o12 {
		return ssz.ErrOffset
	}

	// Offset (13) 'CurrentEpochParticipation'
	if o13 = ssz.ReadOffset(buf[2687168:2687172]); o13 > size || o12 > o13 {
		return ssz.ErrOffset
	}

	// Field (14) 'JustificationBits'
	if cap(b.JustificationBits) == 0 {
		b.JustificationBits = make([]byte, 0, len(buf[2687172:2687173]))
	}
	b.JustificationBits = append(b.JustificationBits, buf[2687172:2687173]...)

	// Field (15) 'PreviousJustifiedCheckpoint'
	if b.PreviousJustifiedCheckpoint == nil {
		b.PreviousJustifiedCheckpoint = new(Checkpoint)
	}
	if err = b.PreviousJustifiedCheckpoint.UnmarshalSSZ(buf[2687173:2687213]); err != nil {
		return err
	}
	...
	if err = b.CurrentJustifiedCheckpoint.UnmarshalSSZ(buf[2687213:2687253]); err != nil {
		return err
	}
	...
	if err = b.FinalizedCheckpoint.UnmarshalSSZ(buf[2687253:2687293]); err != nil {
		return err
	}

	// Offset (18) 'InactivityScores'
	if o18 = ssz.ReadOffset(buf[2687293:2687297]); o18 > size || o13 > o18 {
		return ssz.ErrOffset
	}
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2687297:2711921]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[2711921:2736545]); err != nil {
		return err
	}

	// Offset (21) 'LatestExecutionPayloadHeader'
	if o21 = ssz.ReadOffset(buf[2736545:2736549]); o21 > size || o18 > o21 {
		return ssz.ErrOffset
	}

	// Field (22) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2736549:2736557])

	// Field (23) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2736557:2736565]))

	// Offset (24) 'HistoricalSummaries'
	if o24 = ssz.ReadOffset(buf[2736565:2736569]); o24 > size || o21 > o24 {
		return ssz.ErrOffset
	}

	// Field (25) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2736569:2736577]))

	// Field (26) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[2736577:2736585]))

	// Field (27) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2736585:2736593]))

	// Offset (28) 'PendingDeposits'
	if o28 = ssz.ReadOffset(buf[2736593:2736597]); o28 > size || o24 > o28 {
		return ssz.ErrOffset
	}

	// Offset (29) 'PendingPartialWithdrawals'
	if o29 = ssz.ReadOffset(buf[2736597:2736601]); o29 > size || o28 > o29 {
		return ssz.ErrOffset
	}
